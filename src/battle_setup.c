...
void BattleSetup_StartLegendaryBattle(void)
{
    ...
    CreateBattleStartTask(B_TRANSITION_SIDNEY, MUS_ENCOUNTER_GIRL);
    break;
case SPECIES_REGICE:
gBattleTypeFlags |= BATTLE_TYPE_KYOGRE;
CreateBattleStartTask(B_TRANSITION_REGICE, MUS_ENCOUNTER_FEMALE);
break;
case SPECIES_ZARUDE:
gBattleTypeFlags |= BATTLE_TYPE_RAYQUAZA;
CreateBattleStartTask(B_TRANSITION_BLUR, MUS_ENCOUNTER_AQUA);
break;
case SPECIES_TERRAKION:
CreateBattleStartTask(B_TRANSITION_GLACIA, MUS_ENCOUNTER_GIRL);
break;
...
CreateBattleStartTask(B_TRANSITION_GRID_SQUARES, MUS_ENCOUNTER_SWIMMER);
break;
}
